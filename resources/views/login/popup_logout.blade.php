...
<head>
    ...
    <style>
        ...
        padding-top: 2000px;
        left: 50%; /* Untuk memposisikan di tengah horizontal */
        margin: 0; /* Pastikan margin default direset */
    }

        /* --- Perbaikan: Pastikan CSS ini di luar media query atau dalam media query sendiri --- */
        body {
...
<body>
    ...
    <div class="modal-dialog modal-dialog-centered-custom"> <div class="modal-content text-center p-3">
